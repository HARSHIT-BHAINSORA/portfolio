        ...
        <div className="home">
            ...
            <div className="banner">
                ...
                <div className="description">
                    <p>
                        Since , I started my journey in Web Dev from my frist
                        year of my college ,I have enough knowledge about
                        front-end langauages currently work with react.js
                        framwork. mine upcoming target is to learn more about
                        back-end . and eargly willing to work as a freelancer
                        for business and comsumers users.
                    </p>
                </div>
            </div>
            <div className="work">
